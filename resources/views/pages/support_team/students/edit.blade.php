                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" 
                                       ...
                                       minlength="11" maxlength="11" title="Phone number must be exactly 11 digits" value="{{ $sr->user->phone  }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input  accept="image/*" value="{{ $sr->user->birth_cert  }}" type="file" name="birth_certificate" class="form-input-styled" data-fouc>
                                <span class="form-text text-muted">Accepted Images: jpeg, png. Max file size 2Mb</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-block">Report Card:</label>
                                <input  value="{{ $sr->user->report_card  }}" accept="image/*" type="file" name="report_card" class="form-input-styled" data-fouc>
                                <span class="form-text text-muted">Accepted Images: jpeg, png. Max file size 2Mb</span>
                            </div>
                        </div>
                    </div>
