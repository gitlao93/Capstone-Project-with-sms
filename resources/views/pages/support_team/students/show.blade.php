...
<div class="row">
    ...
    <div class="col-md-9">
                    ...
                    <div class="tab-pane fade show active" id="basic-info">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $sr->my_class->name.' ' . ($s->section->name ?? '') }}</td>
                            </tr>
                            @if($sr->my_parent_id)
                                <tr>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    @if($sr->user->birth_certificate)
                        <div class="col-md-6">
                            <img src="{{ $sr->user->birth_certificate }}" alt="" style="width: 100%; height:100%">
                        </div>
                    @endif
                    @if($sr->user->report_card)
                        <div class="col-md-6">
                            <img src="{{ $sr->user->report_card }}" alt="" style="width: 100%; height:100%">
                        </div>
                    @endif
                </div>
            </div>
